...
#region HEADER
    ...
    [Export] private float ZoomDefaultZoomduration = 0.6f;
...
#region USER METHODS
    ...
    /// Process the shake
    /// </summary>
    private void _Shake(double delta)
    {
        _time += delta;
        ...
        if (_useRotation)
            Rotation = Noise.GetNoise3D(0.0f, 0.0f, (float)(_time * _speed)) * _shakeMaxRoll * amount;
    }
