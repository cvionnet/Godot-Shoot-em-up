...
{
    public Item ItemProperties { get; private set; }
        ...
        if(body != null)
        {
            switch (ItemProperties.SendTo)
            {
                case GameManager.ItemsSendTo.CHARACTER:
                    ...
                    {
                        ((actors.characters.player.Player)body).Item_Action(ItemProperties, body.Name);
                        actionSend = true;
                    }
                    else if (body.IsInGroup("Pnj"))
                    {
                        ((actors.characters.pnj.Pnj)body).Item_Action(ItemProperties, body.Name);
                        actionSend = true;
                    }
...
//*-------------------------------------------------------------------------*//
    ...
    /// </summary>
    public void Initialize_ItemProperties(Item pItemProperties)
    {
